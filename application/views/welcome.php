							...
							<tr>
								...
								<td style="width:1%">
									...
									<div class="actions">
										...
										<a href="<?php echo site_url('/control/stop/'.$name.'/'.$item_name);?>" class="btn btn-mini btn-primary" type="button"><i class="bi bi-square-fill"></i></a>
										<a href="<?php echo site_url('/control/restart/'.$name.'/'.$item_name);?>" class="btn btn-mini btn-primary" type="button"><i class="bi bi-arrow-counterclockwise"></i></a>
										<?php } if($status=='STOPPED' || $status == 'EXITED' || $status=='FATAL'){ ?>
										<a href="<?php echo site_url('/control/start/'.$name.'/'.$item_name);?>" class="btn btn-mini btn-primary" type="button"><i class="bi bi-play-fill"></i></a>
										<?php } ?>
									</div>
								</td>
							</tr>
